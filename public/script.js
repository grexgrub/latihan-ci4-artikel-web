let scroll_pos = 0;
const icon = document.getElementsByClassName('nav-link')
...
icon[1].addEventListener('mouseover', function(){
  this.firstElementChild.firstChild.src = 'book-primary.svg';
})

icon[1].addEventListener('mouseout', function(){
  this.firstElementChild.firstChild.src = 'book.svg';
})
